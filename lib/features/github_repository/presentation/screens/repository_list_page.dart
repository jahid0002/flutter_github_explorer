...
class _RepositoryListPageState extends State<RepositoryListPage> {
  ...
  // Widget _buildCachedContent(BuildContext context, RepositoryListError state) {
  //   return SliverList(
  ...
  //       // Stats header
  //       _buildStatsHeader(state.cachedRepositories!.length),

  //       // Repository list
  //       ...state.cachedRepositories!.map((repository) {
  //         return Padding(
